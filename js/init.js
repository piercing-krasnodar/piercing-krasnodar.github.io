	...
	skel.init({
        ...
        plugins: {
            layers: {
                ...
                topPanel: {
                    states: '/max/wide/normal/narrow/narrower/mobile',
                    position: 'top-center',
                    side: 'top',
                    hidden: true,
                    animation: 'pushY',
                ...
                sidePanel: {
                    states: '/max/wide/normal/narrow/narrower',
                    position: 'top-left',
                    side: 'left',
                    hidden: true,
                    animation: 'revealX',
			...
			if (settings.sectionTransitions) {
                ...
                $('#prices')
                    .scrollwatch({
                        ...
                        range:		0.5,
                        anchor:		'center',
                        init:		function(t) { t.find('.block').addClass('inactive'); },
                        on:			function(t) { t.find('.block').removeClass('inactive'); },
                        off:		function(t) { t.find('.block').addClass('inactive'); }
                    });
